# AstroPortal / SpacePortal 

An interactive repository for  knowledge organization systems (KOS) about astronomy, astronautics and other space (broad) topics is described. It may go by the name of 'AstroPortal' (or Astroportal), 'SpacePortal', 'AstroHub', etc. Scoping decision will help determine the name. The portal (one or many) is conceived as a platform for presenting and storing [KOS's for space data, knowledge and content](https://ontospace.wordpress.com). KOS include: controlled vocabularies, taxonomies, ontologies, knowledge graphs, etc. Space-related topics include: astronomy, astronautics, space science, etc. This work is part of a broader long-standing project on AI [conceptual, semantic & AI knowledge modeling approaches for space](https://ontospace.wordpress.com) 
...
## Status
- As an unfunded personal project to date, sponsors, investors, stakeholders, work partners, and other formal support is needed to realize the concept and develop. The author is open to contract, part-time or full-time opportunities, as well as to PhD study opportunities.   
...
## Considerations for developing a portal
Purpose/use-cases, Accessibility, Feasibility, Maintenance, and Security are some considerations. This includes desired functionalities. The degree of specificity is impotant: generic vs. specific with regard to scope, topic, type of knowledge organization system (semantic artifacts such as ontologies, thesauri, etc.), ownership, etc. If developing multiple repository portals, one may be specific to a group or organization, another may be to a discipline with no bias for the org. or owner of the uploaded KOSs, and so on. The implementation may or may not use existing technologies from industry or other groups, such as OntoPortal. 
...
- - I was [added to the chairs' Sept 2023 presentation in OntoPortal Workshop](https://github.com/rrovetto/rrovetto/blob/b03531e75d5c9f63fccc2a945df5abbc06cba53b/affiliations-and-work/papers/astroportal/PROOF_Lifewatch_Presentation_astroportalRovetto.JPG) where I presented [one slide](https://github.com/rrovetto/rrovetto/blob/b03531e75d5c9f63fccc2a945df5abbc06cba53b/affiliations-and-work/papers/astroportal/Slide_OntoPortalWorkshop2023_RovettoAstroPortal.JPG). In correspondences with them, I expressed an interest in formal (paid) work collaborations with them. I expressed my historical ideation priority, my long-standing effort to find support for this and related projects, and an active need for opportunity.
...
- It is reasonable to hold that it it's both inclusive and ethical to afford a formal partnership given the circumstances. It is reasonable that if a person has shown historical ideation, a need of opportunity, has expressed interest in collaborating, and if the other is well-funded (as in the case of EU funding) or is a stable economic position, that the latter should afford the former opportunity. Help others succeed and you will, as you have succeeded. That is consistent with the so-called open data and open science meme, but also consistent with commonsense morality and sense of social responsibility.   
...
## Attribution
Cite as: Rovetto, Robert J., "AstroPortal", https://github.com/rrovetto/astroportal/
